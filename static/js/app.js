...
function plotCharts(id) {
    ...
    d3.json("data/samples.json").then((data => {
        ...
        Object.entries(individualMetadata).forEach(([key, value]) => {
            ...
            listItem.attr("class", "p-1 bg-transparent");
...
// Visualization using pie chart (this matches the homework screenshot)
        var traceGauge = {
            type: 'pie',
            showlegend: false,
            hole: 0.4,
          ...
          var degrees = 180-(20 * wfreq + weight); // 20 degrees for each of the 9 gauge sections
          var radius = .5;
          var radians = degrees * Math.PI / 180;
